...
// UI Manager Global Instance
static Recoil::UIManager        g_uiManager;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    HWND hwnd = ::CreateWindowW(
        wc.lpszClassName,
        L"Recoil Pattern Recorder & Analyzer v1.0",
        WS_OVERLAPPEDWINDOW,
        100, 100, 1366, 820,
    ...
    // Apply Modern Dark Theme (Task 3.1)
    g_uiManager.ApplyDarkTheme();
    ...
    while (bRunning)
    {
        ...
        // Tick telemetry and auto-finalize state machine
        g_uiManager.Update();
        ...
        // Task 3.1: Menu Bar and Multi-Panel Docking Layout
        g_uiManager.RenderMainMenuBar();
        g_uiManager.SetupDockSpace();

        // Task 3.2: Panel Weapon Profile Manager
        g_uiManager.RenderWeaponProfileManager();

        // Task 3.3: Panel Recording Controller
        g_uiManager.RenderRecordingController();
        ...
        g_uiManager.RenderTelemetryAndSimulator();

        // Modals: Create Profile, Edit Metadata, Delete Profile (Task 3.2.1 & 3.2.3)
        g_uiManager.RenderModals();
